...
test.describe('Suicide Prevention Public Page', () => {
  test('should render the public appendix, crisis routing, and interactive guidance @advisory', async ({ page }) => {
    ...
    await page.locator('[aria-label="Role-based entry paths"]').getByRole('tab', { name: 'I Am Helping Someone' }).click();
    ...
    await page.getByRole('tab', { name: 'Clinical Care' }).click();
    ...
    await page.locator('[aria-label="Public suicide prevention scenarios"]').getByRole('tab', { name: 'I Am Helping Someone' }).click();
    ...
    await page.getByRole('tab', { name: 'Primary Care' }).click();
    ...
    await page.getByRole('tab', { name: 'First 72 Hours' }).click();
    ...
    await page.getByRole('tab', { name: 'Perinatal' }).click();
    ...
    await page.locator('[aria-label="Population-aware prevention views"]').getByRole('tab', { name: 'Disability / Neurodivergence' }).click();
    ...
    await page.getByRole('tab', { name: 'Ask Directly' }).click();
    ...
    await page.locator('[aria-label="Community support path examples"]').getByRole('tab', { name: 'Work / Financial Strain' }).click();
    ...
    await page.locator('[aria-label="Setting playbooks"]').getByRole('tab', { name: 'Work / School' }).click();
